...
function findRepeat(array) {
  ...
  //önce tekrar sayılarını bulalım
  ...
  //istediğim tekrara sahip olanları result array'ine atalım.
...
let str = "";
for (let i = 0; i < 20; i++) {
  if (ucetambolunenler[i] % 5 === 0) {
    str = "Buzz";
  } else if (ucetambolunenler[i] % 3 === 0 && ucetambolunenler[i] % 5 === 0) {
    str = "FizzBuzz";
  } else if (ucetambolunenler[i] % 3 === 0 && ucetambolunenler[i] % 5 !== 0) {
    str = "FizzBuzz";
  } else {
  ...
  console.log("FizBuzz", ucetambolunenler[i], str);
}
